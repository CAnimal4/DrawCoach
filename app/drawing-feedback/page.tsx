...
const pageTitle = "Free Drawing Feedback Online - Drawing Feedback Tool | DrawCoach";
const pageDescription =
  "Get free drawing feedback online with DrawCoach. Upload a sketch and receive simple feedback notes for shading, composition, detail, and clarity.";
      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <section className="py-12">
          ...
          <p className="mt-5 text-base leading-7 text-[#555c65]">
            DrawCoach is a free drawing feedback tool for quick practice notes. Upload a sketch,
        ...
        <section className="border-t border-[#e7e8e5] py-8">
          ...
          <ol className="mt-5 space-y-4 text-sm leading-7 text-[#555c65]">
            ...
            <li>
              <strong className="text-[#161719]">3. Read the feedback.</strong> Get a short summary
        ...
        <section className="border-t border-[#e7e8e5] py-8">
          <h2 className="text-2xl font-semibold">Example feedback</h2>
          ...
          <div className="mt-5 grid gap-5 sm:grid-cols-2">
            <article>
              ...
              <p className="mt-2 text-sm leading-7 text-[#555c65]">
                ...
                feedback then suggests a small value change, such as grouping shadows or adding one
                clearer highlight.
              </p>
            </article>
            <article>
        ...
        <section className="border-t border-[#e7e8e5] py-8">
          ...
          <p className="mt-4 text-sm leading-7 text-[#555c65]">
            This page is for artists searching for free drawing feedback, beginner sketch feedback,
            or a drawing feedback tool that can quickly point out the next practical fix. DrawCoach
